...
const torrentListEl = document.getElementById('torrentList');
...
// =====================================================
function playNext() {
  if (currentListType === 'torrents' || currentListType === 'torrent') return;
  if (currentListType === 'favorites') {
...
function autoplayFirstInList(listType) {
  ...
  // 🧲 Torrents : la liste est gérée par les scripts webtor-*.js, pas d'autoplay ici
  if (listType === 'torrents' || listType === 'torrent') return;
...
document.querySelectorAll('.tab-btn').forEach(btn => {
  btn.addEventListener('click', () => {
    ...
    if (tab === 'torrents') {
      currentListType = 'torrents';
      torrentListEl?.classList.add('active');
      // La liste torrents est gérée par les scripts webtor-*.js
    }
